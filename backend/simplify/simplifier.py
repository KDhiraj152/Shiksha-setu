...
Simplified text:"""
    ...
    def _apply_subject_specific_rules(
        ...
        # For Science: Preserve scientific terminology but add explanations
            ...
            content = self._add_science_explanations(content)
        
        # For Social Studies/History: Simplify historical context
        elif subject in ['Social Studies', 'History']:
            content = self._simplify_historical_context(content)
    ...
    def _add_science_explanations(self, content: str) -> str:
        """
        Add explanations for scientific terms.
    ...
    def _simplify_historical_context(self, content: str) -> str:
        """
        Simplify historical context.
