...
class TokenBlacklist(Base):
    ...
    reason = Column(String(100), nullable=False)  # 'logout', 'rotation', 'compromise', 'expired'
    blacklisted_at = Column(TIMESTAMP, default=utcnow, nullable=False, index=True)
    expires_at = Column(TIMESTAMP, nullable=False)  # When token would have expired naturally
