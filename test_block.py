...
async def test_components():
    ...
    try:
        ...
        logger.warning("⚠ Model Discovery timed out after 5s (might be slow, not blocking)")
    except Exception as e:
    ...
    try:
        ...
        logger.warning("⚠ Model Warmup timed out after 10s (slow but not blocking if async)")
    except Exception as e:
