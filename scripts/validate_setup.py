...
def check_python_version() -> Tuple[bool, str]:
    ...
    return False, f"Python {version.major}.{version.minor}.{version.micro} (requires 3.13+)"
...
def main():
    ...
    if all_checks_passed:
        ...
        print("\n  To start services:")
        print("    Backend:  uvicorn src.api.main:app --reload")
        print("    Worker:   celery -A src.tasks.celery_app worker --loglevel=info")
        ...
        print("    4. Run database migrations: python -c 'from src.database import init_db; init_db()'")
    print("="*70 + "\n")
