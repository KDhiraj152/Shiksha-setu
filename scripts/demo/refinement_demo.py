...
from backend.services.simplify import TextSimplifier, REFINEMENT_AVAILABLE
    ...
    if result1 and result2:
        ...
        if result2.semantic_score is not None:
            ...
            if result2.semantic_score >= TARGET_SCORE:
                ...
                print(f"⚠️  Score below target (need {TARGET_SCORE - result2.semantic_score:.2f} more)")
