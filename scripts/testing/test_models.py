...
def test_simplification_model():
    ...
    try:
        ...
        # Test generation
        prompt = "Simplify this for a 5th grader: Photosynthesis is the biochemical process."
...
def test_validation_model():
    ...
    try:
        ...
        prompt = "Is this text appropriate for grade 5? 'Plants make food using sunlight.'"
